...
<body>
    ...
    <div class="container-xl mt-5 pt-5">
        ...
        <c:choose>
            <c:when test="${vagas != null && empresas == null && curriculo == null}">
<section class="job-list-section py-5">
        <div class="container">
            <h4 class="section-subtitle mb-4">Vagas Encontradas:</h4>
            <c:forEach var="vaga" items="${vagas}">
                ...
                <c:when test="${empresas != null && vagas == null && curriculos == null}">
<section class="job-list-section py-5">
        <div class="container">
            <h4 class="section-subtitle mb-4">Empresas Encontradas:</h4>

                    <c:forEach var="empresa" items="${empresas}">
                        <a href="${pageContext.request.contextPath}/empresa?id=${empresa.id}" class="job-card-link text-decoration-none text-reset">
                            <div class="job-card card mb-3">
                                <div class="card-body d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                                    <div class="d-flex align-items-center mb-3 mb-md-0">
                                        <div class="star-badge position-relative me-3">
                                        ...
                                        <div>
                                            <h5 class="job-title mb-1">${empresa.nome}</h5>
                                            <p class="company-name text-muted mb-0"><i class="far fa-user me-1"></i> ${empresa.email} - ${empresa.telefone}</p>
                                            <small class="text-muted"><i class="fa-solid fa-location-dot"></i> ${empresa.endereco.municipio},  ${empresa.endereco.estado}</small>
                                        </div>
                                    </div>
                                    <div class="job-details text-md-end">
                                        <button class=" apply-now-button">
                                            Ver Perfil <i class="fas fa-arrow-right ms-2"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
            ...
            <c:when test="${curriculos != null && vagas == null && empresas == null}">
            <section class="job-list-section py-5">
                <div class="container">
                    <h4 class="section-subtitle mb-4">Curriculos Encontrados:</h4>


                <c:forEach var="curriculo" items="${curriculos}">
                    <a href="${pageContext.request.contextPath}/curriculo?id=${curriculo.id}" class="job-card-link text-decoration-none text-reset">
                        <div class="job-card card mb-3">
                            <div class="card-body d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                                <div class="d-flex align-items-center mb-3 mb-md-0">
                                    <div class="star-badge position-relative me-3">
                                    ...
                                    <div>
                                        <h5 class="job-title mb-1 d-inline-block text-truncate">${curriculo.habilidades}</h5>
                                        <p class="company-name text-muted mb-0"><i class="far fa-user me-1"></i> ${curriculo.candidato.nome} </p>
                                        <p class="company-name text-muted mb-0"><i class="far fa-user me-1"></i> ${curriculo.candidato.email} - ${curriculo.candidato.telefone}</p>
                                    </div>
                                </div>
                                <div class="job-details text-md-end">
                                    <button class=" apply-now-button">
                                        Ver Curriculo <i class="fas fa-arrow-right ms-2"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
